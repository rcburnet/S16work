...
# Script that will take SFR(OII) values from Seans catalogue (txt tables) and convert it to Halpha flux using K98 relation (SFR = 7.9*10e-42*L(Halpha), L(Halpha) = 4*pi*D**2*Flux(Halpha)).
