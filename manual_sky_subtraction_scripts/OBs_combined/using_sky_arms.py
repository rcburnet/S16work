...
for root,dirnames,filenames in os.walk('/home/rburnet/reflex/project_data/OBs_combined/cubes_from_raw_data/'):
    for filename in fnmatch.filter(filenames, 'CL003[4|6]-[Y|I][J|Z]-OB-[1|2]_reconstructed_KMOS*'):
...
alice = np.array(fitsfiles[1][2].data)
bob = np.array(fitsfiles[0][2].data)

alice = np.nan_to_num(alice)
...
for i in range(len(fitsfiles)):
    ...
    if i == 0 or i == 3 or i == 5 or i == 16 or i == 19 or i == 21 or i == 24:
        ...
        fitsfiles[i].writeto('/home/rburnet/reflex/project_data/OBs_combined/cubes_from_raw_data/manual_sky_subtraction_cubes/'+hdulist[i][-63:])
